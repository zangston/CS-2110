...
public class Feed {
	...
	{
		ArrayList<Meme> shared = new ArrayList<Meme>();
		Feed f = new Feed(shared);
		...
		alex.shareMeme(knucklesMeme, f);
		ben.shareMeme(gfMeme, f);
		chuck.shareMeme(peterMeme, f);
		
		int ratingScore = 1;
		
		alex.rateNextMeme(f, ratingScore);
		ben.rateNextMeme(f, ratingScore);
		chuck.rateNextMeme(f, ratingScore);
		/*
